    ...
    return [TyphoonDefinition withClass:[FHPlacesAPI class]
                          configuration:^(TyphoonDefinition *definition) {
                              [definition useInitializer:@selector(initWithBaseUrl:) parameters:^(TyphoonMethod *method) {
                                  [method injectParameterWith:Configuration.urlFhPlacesApi];
                              }];
                          }];
}

- (id)uiApplication {
    return [TyphoonDefinition withClass:[UIApplicationAdapter class]
                          configuration:^(TyphoonDefinition *definition) {
                              [definition useInitializer:@selector(initWithApp:) parameters:^(TyphoonMethod *method) {
                                  [method injectParameterWith:[UIApplication sharedApplication]];
                              }];
                          }];
}
