...
class SearchResultControlInputTests: XCTestCase {
    func test_encodeAndDecode_ShouldRestoreObject() {
        ...
        let param = RestaurantSearchResult(restaurant: restaurant, searchParams: profile)
        let input = SearchResultControlInput(result: param)
