...
- (NSString *)getGreeting {
    ...
    NSString *dreamName = [self getFood];

    NSString *text = [NSString stringWithFormat:@"Do you look more like %@ or %@?", femaleCelebrity, maleCelebrity];
    NSString *text1 = [NSString stringWithFormat:@"Greetings from %@!", placeName];
    NSString *text2 = [NSString stringWithFormat:@"You just interrupted the most beautiful dream, about ----  %@.", dreamName];
...
- (NSString *)getCommentChoice {
    NSString *text = [NSString stringWithFormat:@"I’ll tell you what to order—some eggs and bacon with mayonnaise. That’s %@’s favorite.", [self getCelebrity]];
